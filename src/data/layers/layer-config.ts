...
export const layerConfigs: LayerConfig[] = [
  // Physical
  { id: "layer-rivers",     group: "physical",    label: "Rivers",               defaultVisible: false,  description: "Jordan, Arnon, Jabbok, Euphrates, Nile and more" },
  { id: "layer-seas",       group: "physical",    label: "Seas & Lakes",         defaultVisible: false,  description: "Mediterranean, Dead Sea, Sea of Galilee, Red Sea" },
  ...
  // Political
  { id: "layer-regions",              group: "political", label: "Political Regions",      defaultVisible: false,  description: "Colored overlays showing who controls each region — updates each chapter" },
  ...
  { id: "layer-journey-routes",  group: "movements", label: "Journey Routes",      defaultVisible: false,  description: "Israel's journeys and pilgrimages — chapter-specific with arrows" },
  { id: "layer-military-routes", group: "movements", label: "Military Campaigns",  defaultVisible: false,  description: "Conquest routes and military movements — chapter-specific with arrows" },

  // Settlements
  { id: "layer-cities-major",          group: "settlements", label: "Major Cities",           defaultVisible: false,  description: "Capital-tier cities and major population centers" },
  ...
  // Events
  { id: "layer-special-sites-tabernacle", group: "events", label: "Tabernacle Locations", defaultVisible: false,  description: "Sites where the Tabernacle was pitched" },
  { id: "layer-special-sites-covenant",   group: "events", label: "Covenant Sites",       defaultVisible: false,  description: "Locations of God's covenant ceremonies with Israel" },
  ...
  // Labels
  { id: "layer-labels-regions", group: "labels", label: "Region Labels", defaultVisible: false,  description: "Text labels for political regions" },
  { id: "layer-labels-rivers",  group: "labels", label: "River Labels",  defaultVisible: false,  description: "Text labels for rivers and wadis" },
  { id: "layer-labels-cities",  group: "labels", label: "City Labels",   defaultVisible: false,  description: "Text labels for city markers" },
